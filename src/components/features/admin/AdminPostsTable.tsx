                ...
                <tr key={id}>
                  ...
                  <td>
                    <div className="admin-actions">
                      {st === "published" ? (
                        <button className="btn btn-outline btn-xs" onClick={() => onUpdateStatus(id, "private", postStatusLabel("private"))}>
                          非公開
                        </button>
                      ) : (
                        <button className="btn btn-outline btn-xs" onClick={() => onUpdateStatus(id, "published", postStatusLabel("published"))}>
                          公開
                        </button>
                      )}
